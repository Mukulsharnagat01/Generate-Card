...
import { Move, Expand, Menu, X, Download, Upload } from "lucide-react";
            ...
            >
              ...
              >
                ...
                >
                    ...
                    {showBack ? (
                      ...
                      !isEditLayout ? (
                        ...
                        <div className="w-full h-full relative">
                          ...
                          {/* Logo (if exists) - EDITED FOR BETTER VISIBILITY */}
                          {previewData.logo && (
                            <div
                  ...
                  {/* Edit Mode Indicator - RESPONSIVE */}
                  {isEditLayout && (
            ...
            <div className="flex border-b bg-gray-50/50 overflow-x-auto scrollbar-hide">
              {['general', 'design', 'qr', 'content', 'layout'].map(tab => (
                <button
                  ...
                  className={`px-4 py-3 text-xs sm:text-sm font-medium capitalize transition-colors whitespace-nowrap min-w-[80px] flex-shrink-0 ${activeTab === tab
...
// import { Button } from "@/components/ui/button";
// import { QRCodeSVG } from "qrcode.react";
// import { Move, Expand, Menu, X } from "lucide-react";
...
//               {/* Edit Mode Indicator */}
//               {isEditLayout && (
//                 <div className="absolute top-2 left-2 bg-blue-500 text-white text-xs px-2 py-1 rounded hidden sm:block">
...
//                           Times New Roman (Formal Classic)
//                         </option>
//                         <option value="Garamond, serif">
//                           Garamond (Elegant Old-Style)
//                         </option>

//                         <option value="Courier New, monospace">
//                           Courier New (Mono Retro)
//                         </option>
//                         <option value="Lucida Console, monospace">
//                           Lucida Console (Tech Mono)
//                         </option>
//                         <option value="'Brush Script MT', cursive">Brush Script (Elegant Handwriting)</option>
//   <option value="'Comic Sans MS', cursive">Comic Sans (Casual Handwriting)</option>
//                       </select>
